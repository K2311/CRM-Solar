<x-app-layout title="Edit Payment">
    <div style="max-width: 600px; margin: 0 auto;">
        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
            ...
            <div>
                <h1 style="font-size: 1.5rem; font-weight: 800; margin-bottom: 0.25rem;">Edit Payment</h1>
                <p style="color: var(--text-muted);">Update details for this payment transaction.</p>
            </div>
        </div>
        ...
        <div class="card glass-card" x-data="paymentForm({
            ...
            selectedQuoteId: '{{ old('quote_id', $payment->quote_id) }}'
        })">
            <form action="{{ route('payments.update', $payment) }}" method="POST" enctype="multipart/form-data">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="number" step="0.01" name="amount" class="form-control" value="{{ old('amount', $payment->amount) }}" style="padding-left: 2.5rem;" required>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reference" class="form-control" value="{{ old('reference', $payment->reference) }}" placeholder="Transaction ID, Cheque #, etc.">
                </div>

                <div class="form-group">
                    <label class="form-label">Notes</label>
                    <textarea name="notes" class="form-control" rows="3" placeholder="Additional details...">{{ old('notes', $payment->notes) }}</textarea>
                </div>
