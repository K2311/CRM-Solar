            ...
            <nav class="sidebar-nav">
                ...
                @if(auth()->user()->canDo('quotes.view'))
                    <a href="{{ route('quotes.index') }}"
                        class="nav-item {{ request()->routeIs('quotes.*') ? 'active' : '' }}">
                ...
                @if(auth()->user()->canDo('installations.view'))
                    <a href="{{ route('installations.index') }}"
                        class="nav-item {{ request()->routeIs('installations.*') ? 'active' : '' }}">
                ...
                @if(auth()->user()->canDo('marketing.view'))
                    <a href="{{ route('campaigns.index') }}"
                        class="nav-item {{ request()->routeIs('campaigns.*') || request()->routeIs('templates.*') ? 'active' : '' }}">
                ...
                @if(auth()->user()->canDo('marketing.view'))
                    <a href="{{ route('social.index') }}"
                        class="nav-item {{ request()->routeIs('social.*') ? 'active' : '' }}">
